...
public class WinUserBasicTable extends TableImpl<WinUserBasicRecord> implements WingsAliasTable<WinUserBasicTable>, LightIdAware {
     ...
     */
    public final TableField<WinUserBasicRecord, UserGender> Gender = createField(DSL.name("gender"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.inline("0", SQLDataType.INTEGER)), this, "", new JooqConsEnumConverter(UserGender.class));
     ...
     */
    public final TableField<WinUserBasicRecord, UserStatus> Status = createField(DSL.name("status"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.inline("0", SQLDataType.INTEGER)), this, "", new JooqConsEnumConverter(UserStatus.class));
