...
public class WinRoleRoleMap implements IWinRoleRoleMap {
    ...
    public WinRoleRoleMap() {}

    public WinRoleRoleMap(IWinRoleRoleMap value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final WinRoleRoleMap other = (WinRoleRoleMap) obj;
        if (referRole == null) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("WinRoleRoleMap (");
