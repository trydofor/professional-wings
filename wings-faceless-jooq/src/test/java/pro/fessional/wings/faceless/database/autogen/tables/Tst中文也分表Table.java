...
public class Tst中文也分表Table extends TableImpl<Tst中文也分表Record> implements WingsAliasTable<Tst中文也分表Table>, LightIdAware {
     ...
     */
    public final TableField<Tst中文也分表Record, StandardLanguage> Language = createField(DSL.name("language"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.inline("1020111", SQLDataType.INTEGER)), this, "", JooqConsEnumConverter.of(StandardLanguage.class));
