...
public class SysConstantEnumDao extends WingsJooqDaoImpl<SysConstantEnumTable, SysConstantEnumRecord, SysConstantEnum, Integer> {
     ...
     */
    public List<SysConstantEnum> fetchRangeOfDesc(String lowerInclusive, String upperInclusive) {
        return fetchRange(SysConstantEnumTable.SysConstantEnum.Desc, lowerInclusive, upperInclusive);
    }
