 ...
 * @since 2019-05-21
 */
public class WingsShardingSphereEnvsPostProcessor implements EnvironmentPostProcessor {

    private static final DeferredLog logger = WingsDeferredLogFactory.getLog(WingsShardingSphereEnvsPostProcessor.class);
