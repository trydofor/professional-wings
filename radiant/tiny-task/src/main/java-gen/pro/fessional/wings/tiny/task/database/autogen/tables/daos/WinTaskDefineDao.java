...
public class WinTaskDefineDao extends WingsJooqDaoJournalImpl<WinTaskDefineTable, WinTaskDefineRecord, WinTaskDefine, Long> {
    ...
    /**
     * Fetch records that have <code>timing_tune BETWEEN lowerInclusive AND
     * upperInclusive</code>
     */
    public List<WinTaskDefine> fetchRangeOfTimingTune(Integer lowerInclusive, Integer upperInclusive) {
        return fetchRange(WinTaskDefineTable.WinTaskDefine.TimingTune, lowerInclusive, upperInclusive);
    }


    public List<WinTaskDefine> fetchRangeOfTimingTuneLive(Integer lowerInclusive, Integer upperInclusive) {
        return fetchRangeLive(WinTaskDefineTable.WinTaskDefine.TimingTune, lowerInclusive, upperInclusive);
    }

    /**
     * Fetch records that have <code>timing_tune IN (values)</code>
     */
    public List<WinTaskDefine> fetchByTimingTune(Integer... values) {
        return fetch(WinTaskDefineTable.WinTaskDefine.TimingTune, values);
    }

    public List<WinTaskDefine> fetchByTimingTune(Collection<? extends Integer> values) {
        return fetch(WinTaskDefineTable.WinTaskDefine.TimingTune, values);
    }


    public List<WinTaskDefine> fetchByTimingTuneLive(Integer... values) {
        return fetchLive(WinTaskDefineTable.WinTaskDefine.TimingTune, values);
    }

    public List<WinTaskDefine> fetchByTimingTuneLive(Collection<? extends Integer> values) {
        return fetchLive(WinTaskDefineTable.WinTaskDefine.TimingTune, values);
    }
     ...
     * upperInclusive</code>
     */
    public List<WinTaskDefine> fetchRangeOfTimingMiss(Long lowerInclusive, Long upperInclusive) {
        return fetchRange(WinTaskDefineTable.WinTaskDefine.TimingMiss, lowerInclusive, upperInclusive);
    }


    public List<WinTaskDefine> fetchRangeOfTimingMissLive(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<WinTaskDefine> fetchByTimingMiss(Long... values) {
        return fetch(WinTaskDefineTable.WinTaskDefine.TimingMiss, values);
    }

    public List<WinTaskDefine> fetchByTimingMiss(Collection<? extends Long> values) {
        return fetch(WinTaskDefineTable.WinTaskDefine.TimingMiss, values);
    }


    public List<WinTaskDefine> fetchByTimingMissLive(Long... values) {
        return fetchLive(WinTaskDefineTable.WinTaskDefine.TimingMiss, values);
    }

    public List<WinTaskDefine> fetchByTimingMissLive(Collection<? extends Long> values) {
        return fetchLive(WinTaskDefineTable.WinTaskDefine.TimingMiss, values);
    }
     ...
     * upperInclusive</code>
     */
    public List<WinTaskDefine> fetchRangeOfTimingBeat(Long lowerInclusive, Long upperInclusive) {
        return fetchRange(WinTaskDefineTable.WinTaskDefine.TimingBeat, lowerInclusive, upperInclusive);
    }


    public List<WinTaskDefine> fetchRangeOfTimingBeatLive(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<WinTaskDefine> fetchByTimingBeat(Long... values) {
        return fetch(WinTaskDefineTable.WinTaskDefine.TimingBeat, values);
    }

    public List<WinTaskDefine> fetchByTimingBeat(Collection<? extends Long> values) {
        return fetch(WinTaskDefineTable.WinTaskDefine.TimingBeat, values);
    }


    public List<WinTaskDefine> fetchByTimingBeatLive(Long... values) {
        return fetchLive(WinTaskDefineTable.WinTaskDefine.TimingBeat, values);
    }

    public List<WinTaskDefine> fetchByTimingBeatLive(Collection<? extends Long> values) {
        return fetchLive(WinTaskDefineTable.WinTaskDefine.TimingBeat, values);
    }
