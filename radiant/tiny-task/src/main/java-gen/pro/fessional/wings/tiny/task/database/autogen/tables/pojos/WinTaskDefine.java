...
public class WinTaskDefine implements IWinTaskDefine {
    ...
    private Long timingMiss;
    private Long timingBeat;
     ...
     */
    @Override
    public void setTimingMiss(Long timingMiss) {
        this.timingMiss = timingMiss;
    }

    @Transient
    public void setTimingMissIf(Long timingMiss, boolean bool) {
        if (bool) {
            this.timingMiss = timingMiss;
        }
    }
    ...
    @Transient
    public void setTimingMissIf(Supplier<Long> timingMiss, boolean bool) {
        if (bool) {
    ...
    @Transient
    public void setTimingMissIf(Long timingMiss, Predicate<Long> bool) {
    ...
    @Transient
    public void setTimingMissIf(Long timingMiss, Predicate<Long> bool, Supplier<Long>... timingMisss) {
        if (bool.test(timingMiss)) {
            this.timingMiss = timingMiss;
            return;
        }
        for (Supplier<Long> supplier : timingMisss) {
    ...
    @Transient
    public void setTimingMissIfNot(Long timingMiss, Predicate<Long> bool) {
        if (!bool.test(timingMiss)) {
            this.timingMiss = timingMiss;
        }
    }
    ...
    @Transient
    public void setTimingMissIfNot(Long timingMiss, Predicate<Long> bool, Supplier<Long>... timingMisss) {
        if (!bool.test(timingMiss)) {
            this.timingMiss = timingMiss;
            return;
        }
    ...
    @Transient
    public void setTimingMissIf(UnaryOperator<Long> timingMiss) {
     ...
     */
    @Override
    public void setTimingBeat(Long timingBeat) {
        this.timingBeat = timingBeat;
    }

    @Transient
    public void setTimingBeatIf(Long timingBeat, boolean bool) {
        if (bool) {
            this.timingBeat = timingBeat;
        }
    }
    ...
    @Transient
    public void setTimingBeatIf(Supplier<Long> timingBeat, boolean bool) {
        if (bool) {
    ...
    @Transient
    public void setTimingBeatIf(Long timingBeat, Predicate<Long> bool) {
    ...
    @Transient
    public void setTimingBeatIf(Long timingBeat, Predicate<Long> bool, Supplier<Long>... timingBeats) {
        if (bool.test(timingBeat)) {
            this.timingBeat = timingBeat;
            return;
        }
        for (Supplier<Long> supplier : timingBeats) {
    ...
    @Transient
    public void setTimingBeatIfNot(Long timingBeat, Predicate<Long> bool) {
        if (!bool.test(timingBeat)) {
            this.timingBeat = timingBeat;
        }
    }
    ...
    @Transient
    public void setTimingBeatIfNot(Long timingBeat, Predicate<Long> bool, Supplier<Long>... timingBeats) {
        if (!bool.test(timingBeat)) {
            this.timingBeat = timingBeat;
            return;
        }
    ...
    @Transient
    public void setTimingBeatIf(UnaryOperator<Long> timingBeat) {
