...
public class WinTaskDefineTable extends TableImpl<WinTaskDefineRecord> implements WingsJournalTable<WinTaskDefineTable>, LightIdAware {
    ...
    @Override
    public List<UniqueKey<WinTaskDefineRecord>> getKeys() {
        return Arrays.<UniqueKey<WinTaskDefineRecord>>asList(
              Internal.createUniqueKey(WinTaskDefineTable.WinTaskDefine, DSL.name("KEY_win_task_define_PRIMARY"), new TableField[] { WinTaskDefineTable.WinTaskDefine.Id }, true)
        );
    }
