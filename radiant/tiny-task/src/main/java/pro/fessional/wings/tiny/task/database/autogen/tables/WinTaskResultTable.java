...
public class WinTaskResultTable extends TableImpl<WinTaskResultRecord> implements WingsJournalTable<WinTaskResultTable>, LightIdAware {
     ...
     */
    public final TableField<WinTaskResultRecord, Long> TimeCost = createField(DSL.name("time_cost"), SQLDataType.BIGINT.nullable(false).defaultValue(DSL.inline("0", SQLDataType.BIGINT)), this, "");
