CREATE TABLE `win_task_define` (
    ...
    `enabled`     BOOLEAN      NOT NULL DEFAULT '1' COMMENT 'whether to register and execute',
    `autorun`     BOOLEAN      NOT NULL DEFAULT '1' COMMENT 'whether to auto register and start',
    ...
    `tasker_para` TEXT         NULL COMMENT 'parameters of the task, object array in json format',
    `tasker_name` VARCHAR(200) NOT NULL DEFAULT '' COMMENT 'task name, used for notice and log, shortClassName#method',
    `tasker_fast` BOOLEAN      NOT NULL DEFAULT '1' COMMENT 'whether light task, fast execution, completed in seconds',
    ...
    `timing_tune` INT          NOT NULL DEFAULT '0' COMMENT 'execute before or after tune (seconds)',
    `timing_miss` BIGINT       NOT NULL DEFAULT '0' COMMENT 'within how many seconds of a misfire, default auto calc',
    `timing_beat` BIGINT       NOT NULL DEFAULT '0' COMMENT 'interval seconds of heartbeat, default auto calc',
...
CREATE TABLE `win_task_result` (
    ...
    `exit_data` TEXT         NULL COMMENT 'return (json) or exception (stacktrace)',
    `exit_fail` BOOLEAN      NOT NULL DEFAULT '0' COMMENT 'whether fail',
