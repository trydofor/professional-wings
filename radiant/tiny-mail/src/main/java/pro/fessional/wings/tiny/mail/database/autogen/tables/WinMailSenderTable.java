...
public class WinMailSenderTable extends TableImpl<WinMailSenderRecord> implements WingsJournalTable<WinMailSenderTable>, LightIdAware {
     ...
     */
    public final TableField<WinMailSenderRecord, LocalDateTime> CreateDt = createField(DSL.name("create_dt"), SQLDataType.LOCALDATETIME(3).nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP(3)", SQLDataType.LOCALDATETIME)), this, "");
    ...
    @Override
    public List<UniqueKey<WinMailSenderRecord>> getKeys() {
        return Arrays.<UniqueKey<WinMailSenderRecord>>asList(
              Internal.createUniqueKey(WinMailSenderTable.WinMailSender, DSL.name("KEY_win_mail_sender_PRIMARY"), new TableField[] { WinMailSenderTable.WinMailSender.Id }, true)
        );
    }
