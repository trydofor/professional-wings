...
public class WinMailSenderDao extends WingsJooqDaoJournalImpl<WinMailSenderTable, WinMailSenderRecord, WinMailSender, Long> {
    ...
    /**
     * Fetch records that have <code>lazy_bean BETWEEN lowerInclusive AND
     * upperInclusive</code>
     */
    public List<WinMailSender> fetchRangeOfLazyBean(String lowerInclusive, String upperInclusive) {
        return fetchRange(WinMailSenderTable.WinMailSender.LazyBean, lowerInclusive, upperInclusive);
    }


    public List<WinMailSender> fetchRangeOfLazyBeanLive(String lowerInclusive, String upperInclusive) {
        return fetchRangeLive(WinMailSenderTable.WinMailSender.LazyBean, lowerInclusive, upperInclusive);
    }

    /**
     * Fetch records that have <code>lazy_bean IN (values)</code>
     */
    public List<WinMailSender> fetchByLazyBean(String... values) {
        return fetch(WinMailSenderTable.WinMailSender.LazyBean, values);
    }

    public List<WinMailSender> fetchByLazyBean(Collection<? extends String> values) {
        return fetch(WinMailSenderTable.WinMailSender.LazyBean, values);
    }


    public List<WinMailSender> fetchByLazyBeanLive(String... values) {
        return fetchLive(WinMailSenderTable.WinMailSender.LazyBean, values);
    }

    public List<WinMailSender> fetchByLazyBeanLive(Collection<? extends String> values) {
        return fetchLive(WinMailSenderTable.WinMailSender.LazyBean, values);
    }

    /**
     * Fetch records that have <code>lazy_para BETWEEN lowerInclusive AND
     * upperInclusive</code>
     */
    public List<WinMailSender> fetchRangeOfLazyPara(String lowerInclusive, String upperInclusive) {
        return fetchRange(WinMailSenderTable.WinMailSender.LazyPara, lowerInclusive, upperInclusive);
    }


    public List<WinMailSender> fetchRangeOfLazyParaLive(String lowerInclusive, String upperInclusive) {
        return fetchRangeLive(WinMailSenderTable.WinMailSender.LazyPara, lowerInclusive, upperInclusive);
    }

    /**
     * Fetch records that have <code>lazy_para IN (values)</code>
     */
    public List<WinMailSender> fetchByLazyPara(String... values) {
        return fetch(WinMailSenderTable.WinMailSender.LazyPara, values);
    }

    public List<WinMailSender> fetchByLazyPara(Collection<? extends String> values) {
        return fetch(WinMailSenderTable.WinMailSender.LazyPara, values);
    }


    public List<WinMailSender> fetchByLazyParaLive(String... values) {
        return fetchLive(WinMailSenderTable.WinMailSender.LazyPara, values);
    }

    public List<WinMailSender> fetchByLazyParaLive(Collection<? extends String> values) {
        return fetchLive(WinMailSenderTable.WinMailSender.LazyPara, values);
    }
