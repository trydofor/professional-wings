...
public class WinMailSenderRecord extends UpdatableRecordImpl<WinMailSenderRecord> implements IWinMailSender {
     ...
     */
    public WinMailSenderRecord(Long id, LocalDateTime createDt, LocalDateTime modifyDt, LocalDateTime deleteDt, Long commitId, String mailApps, String mailRuns, String mailConf, String mailFrom, String mailTo, String mailCc, String mailBcc, String mailReply, String mailSubj, String mailText, Boolean mailHtml, String mailFile, String mailMark, LocalDateTime mailDate, String lazyBean, String lazyPara, LocalDateTime lastSend, String lastFail, LocalDateTime lastDone, Integer lastCost, LocalDateTime nextSend, Integer nextLock, Integer sumSend, Integer sumFail, Integer sumDone, Integer maxFail, Integer maxDone, Integer refType, Long refKey1, String refKey2) {
        super(WinMailSenderTable.WinMailSender);
        ...
        setLazyBean(lazyBean);
        setLazyPara(lazyPara);
    ...
    public WinMailSenderRecord(WinMailSender value) {
        ...
        if (value != null) {
            ...
            setLazyBean(value.getLazyBean());
            setLazyPara(value.getLazyPara());
