...
public class WinConfRuntimeTable extends TableImpl<WinConfRuntimeRecord> implements WingsJournalTable<WinConfRuntimeTable> {
     ...
     */
    public final TableField<WinConfRuntimeRecord, String> Current = createField(DSL.name("current"), SQLDataType.VARCHAR(3000).nullable(false).defaultValue(DSL.inline("", SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>win_conf_runtime.previous</code>.
     */
    public final TableField<WinConfRuntimeRecord, String> Previous = createField(DSL.name("previous"), SQLDataType.VARCHAR(3000).nullable(false).defaultValue(DSL.inline("", SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>win_conf_runtime.initial</code>.
     */
    public final TableField<WinConfRuntimeRecord, String> Initial = createField(DSL.name("initial"), SQLDataType.VARCHAR(3000).nullable(false).defaultValue(DSL.inline("", SQLDataType.VARCHAR)), this, "");
