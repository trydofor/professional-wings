...
public class SysStandardI18nTable extends TableImpl<SysStandardI18nRecord> implements LightIdAware {

    private static final long serialVersionUID = 486742880;
    ...
    public UniqueKey<SysStandardI18nRecord> getPrimaryKey() {
        return Internal.createUniqueKey(pro.fessional.wings.example.database.autogen.tables.SysStandardI18nTable.SysStandardI18n, "KEY_sys_standard_i18n_PRIMARY", pro.fessional.wings.example.database.autogen.tables.SysStandardI18nTable.SysStandardI18n.Base, pro.fessional.wings.example.database.autogen.tables.SysStandardI18nTable.SysStandardI18n.Kind, pro.fessional.wings.example.database.autogen.tables.SysStandardI18nTable.SysStandardI18n.Ukey, pro.fessional.wings.example.database.autogen.tables.SysStandardI18nTable.SysStandardI18n.Lang);
    }

    @Override
    public List<UniqueKey<SysStandardI18nRecord>> getKeys() {
        return Arrays.<UniqueKey<SysStandardI18nRecord>>asList(
              Internal.createUniqueKey(pro.fessional.wings.example.database.autogen.tables.SysStandardI18nTable.SysStandardI18n, "KEY_sys_standard_i18n_PRIMARY", pro.fessional.wings.example.database.autogen.tables.SysStandardI18nTable.SysStandardI18n.Base, pro.fessional.wings.example.database.autogen.tables.SysStandardI18nTable.SysStandardI18n.Kind, pro.fessional.wings.example.database.autogen.tables.SysStandardI18nTable.SysStandardI18n.Ukey, pro.fessional.wings.example.database.autogen.tables.SysStandardI18nTable.SysStandardI18n.Lang)
        );
    }
