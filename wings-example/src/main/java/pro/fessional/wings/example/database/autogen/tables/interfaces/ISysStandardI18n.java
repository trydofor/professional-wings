...
public interface ISysStandardI18n extends Serializable {
     ...
     */
    public void from(pro.fessional.wings.example.database.autogen.tables.interfaces.ISysStandardI18n from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface ISysStandardI18n
     */
    public <E extends pro.fessional.wings.example.database.autogen.tables.interfaces.ISysStandardI18n> E into(E into);
}
