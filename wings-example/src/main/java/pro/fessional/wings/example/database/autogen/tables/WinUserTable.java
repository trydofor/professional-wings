...
/**
 * The table <code>wings.win_user</code>.
 */
@Generated(
    value = {
        "http://www.jooq.org",
...
public class WinUserTable extends TableImpl<WinUserRecord> implements LightIdAware {
     ...
     */
    public final TableField<WinUserRecord, String> AuthSet = createField(DSL.name("auth_set"), org.jooq.impl.SQLDataType.VARCHAR(2000).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "权限集:authority#401####，逗号分割，临时增减，负数表减");
