...
public class WingsInitProjectSwing extends javax.swing.JFrame {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WingsInitProjectSwing.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
    ...
    private void generatePrj() {
        ...
        try {
            ...
            info.srcDir = new File(txtWingsPath.getText());
            info.dstDir = new File(txtProjectPath.getText());
            info.dstCodeName = txtCodeName.getText();
            info.dstArtifactId = txtArtifactId.getText();
            info.dstGroupId = txtGroupId.getText();
            info.dstPackage = txtPackage.getText();
            info.version = txtWingsVer.getText();
