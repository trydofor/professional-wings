...
import static com.moilioncircle.roshan.devops.project.Devops0ProjectConstant.DUMP_PATH;
import static com.moilioncircle.roshan.devops.project.Devops0ProjectConstant.DUMP_TYPE;
...
public class Devops7SchemaDumperTest {
    ...
    public void dumpSchema() {
        ...
        String root = DUMP_PATH + DUMP_TYPE;
