...
public class SysStandardI18nTable extends TableImpl<SysStandardI18nRecord> implements LightIdAware {
    ...
    private static final long serialVersionUID = -349288243;
    ...
    public static final SysStandardI18nTable SysStandardI18n$del = SysStandardI18n.rename("sys_standard_i18n$del").as("m5d");
    public static final SysStandardI18nTable SysStandardI18n$upd = SysStandardI18n.rename("sys_standard_i18n$upd").as("m5u");
