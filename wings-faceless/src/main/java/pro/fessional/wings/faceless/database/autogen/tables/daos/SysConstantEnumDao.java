...
public class SysConstantEnumDao extends WingsJooqDaoImpl<SysConstantEnumTable, SysConstantEnumRecord, SysConstantEnum, Integer> {
    ...
    public SysConstantEnumDao(Configuration configuration) {
        super(SysConstantEnumTable.SysConstantEnum, SysConstantEnumTable.asK5, SysConstantEnum.class, configuration, SysConstantEnumTable.SysConstantEnum$del, SysConstantEnumTable.SysConstantEnum$upd);
    }
