...
@Generated(
    ...
    date = "2020-06-13T13:34:27.692Z",
    comments = "This class is generated by jOOQ"
)
@SuppressWarnings({ "all", "unchecked", "rawtypes" })
public class SysConstantEnumTable extends TableImpl<SysConstantEnumRecord> implements LightIdAware {

    private static final long serialVersionUID = -841796605;
    ...
    public static final SysConstantEnumTable SysConstantEnum$del = SysConstantEnum.rename("sys_constant_enum$del").as("k5d");
    public static final SysConstantEnumTable SysConstantEnum$upd = SysConstantEnum.rename("sys_constant_enum$upd").as("k5u");
    ...
    public UniqueKey<SysConstantEnumRecord> getPrimaryKey() {
        return Internal.createUniqueKey(pro.fessional.wings.faceless.database.autogen.tables.SysConstantEnumTable.SysConstantEnum, "KEY_sys_constant_enum_PRIMARY", pro.fessional.wings.faceless.database.autogen.tables.SysConstantEnumTable.SysConstantEnum.Id);
    }

    @Override
    public List<UniqueKey<SysConstantEnumRecord>> getKeys() {
        return Arrays.<UniqueKey<SysConstantEnumRecord>>asList(
              Internal.createUniqueKey(pro.fessional.wings.faceless.database.autogen.tables.SysConstantEnumTable.SysConstantEnum, "KEY_sys_constant_enum_PRIMARY", pro.fessional.wings.faceless.database.autogen.tables.SysConstantEnumTable.SysConstantEnum.Id)
        );
    }
