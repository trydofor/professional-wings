...
public class DefaultSchema extends SchemaImpl {
    ...
    private static final long serialVersionUID = 132676540;
     ...
     */
    public final SysCommitJournalTable SYS_COMMIT_JOURNAL = pro.fessional.wings.faceless.database.autogen.tables.SysCommitJournalTable.SYS_COMMIT_JOURNAL;
    ...
    private final List<Table<?>> getTables0() {
        return Arrays.<Table<?>>asList(
            SysCommitJournalTable.SYS_COMMIT_JOURNAL);
    }
}
