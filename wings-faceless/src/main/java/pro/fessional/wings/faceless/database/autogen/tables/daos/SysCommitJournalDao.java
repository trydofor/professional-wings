...
public class SysCommitJournalDao extends WingsJooqDaoImpl<SysCommitJournalTable, SysCommitJournalRecord, SysCommitJournal, Long> {
    ...
    public SysCommitJournalDao(Configuration configuration) {
        super(SysCommitJournalTable.SysCommitJournal, SysCommitJournalTable.asN6, SysCommitJournal.class, configuration, SysCommitJournalTable.SysCommitJournal$del, SysCommitJournalTable.SysCommitJournal$upd);
    }
