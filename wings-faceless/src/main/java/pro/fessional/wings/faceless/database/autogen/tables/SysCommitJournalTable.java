...
public class SysCommitJournalTable extends TableImpl<SysCommitJournalRecord> implements LightIdAware {
    ...
    private static final long serialVersionUID = -209135067;

    /**
     * The reference instance of <code>SYS_COMMIT_JOURNAL</code>
     */
    public static final SysCommitJournalTable SYS_COMMIT_JOURNAL = new SysCommitJournalTable().as("t1");
    ...
    public UniqueKey<SysCommitJournalRecord> getPrimaryKey() {
        return Internal.createUniqueKey(pro.fessional.wings.faceless.database.autogen.tables.SysCommitJournalTable.SYS_COMMIT_JOURNAL, "KEY_SYS_COMMIT_JOURNAL_PRIMARY", pro.fessional.wings.faceless.database.autogen.tables.SysCommitJournalTable.SYS_COMMIT_JOURNAL.ID);
    }
    ...
    public List<UniqueKey<SysCommitJournalRecord>> getKeys() {
        return Arrays.<UniqueKey<SysCommitJournalRecord>>asList(
              Internal.createUniqueKey(pro.fessional.wings.faceless.database.autogen.tables.SysCommitJournalTable.SYS_COMMIT_JOURNAL, "KEY_SYS_COMMIT_JOURNAL_PRIMARY", pro.fessional.wings.faceless.database.autogen.tables.SysCommitJournalTable.SYS_COMMIT_JOURNAL.ID)
        );
    }
