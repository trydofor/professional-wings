...
public class SysCommitJournalTable extends TableImpl<SysCommitJournalRecord> implements LightIdAware {
     ...
     */
    public final TableField<SysCommitJournalRecord, LocalDateTime> CreateDt = createField(DSL.name("create_dt"), org.jooq.impl.SQLDataType.LOCALDATETIME.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP(3)", org.jooq.impl.SQLDataType.LOCALDATETIME)), this, "创建日时");
    ...
    private SysCommitJournalTable(Name alias, Table<SysCommitJournalRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("104/数据变更集"));
    }
