...
public class SysCommitJournal extends TableImpl<SysCommitJournalRecord> implements LightIdAware {
    ...
    private static final long serialVersionUID = 108896145;
    ...
    public UniqueKey<SysCommitJournalRecord> getPrimaryKey() {
        return Internal.createUniqueKey(pro.fessional.wings.faceless.database.autogen.tables.SysCommitJournal.SYS_COMMIT_JOURNAL, "KEY_SYS_COMMIT_JOURNAL_PRIMARY", pro.fessional.wings.faceless.database.autogen.tables.SysCommitJournal.SYS_COMMIT_JOURNAL.ID);
    }
    ...
    public List<UniqueKey<SysCommitJournalRecord>> getKeys() {
        return Arrays.<UniqueKey<SysCommitJournalRecord>>asList(
              Internal.createUniqueKey(pro.fessional.wings.faceless.database.autogen.tables.SysCommitJournal.SYS_COMMIT_JOURNAL, "KEY_SYS_COMMIT_JOURNAL_PRIMARY", pro.fessional.wings.faceless.database.autogen.tables.SysCommitJournal.SYS_COMMIT_JOURNAL.ID)
        );
    }
