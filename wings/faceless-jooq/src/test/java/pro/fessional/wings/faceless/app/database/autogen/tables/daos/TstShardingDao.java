...
public class TstShardingDao extends WingsJooqDaoJournalImpl<TstShardingTable, TstShardingRecord, TstSharding, Long> {
     ...
     * upperInclusive</code>
     */
    public List<TstSharding> fetchRangeOfLanguage(StandardLanguage lowerInclusive, StandardLanguage upperInclusive) {
        return fetchRange(TstShardingTable.TstSharding.Language, lowerInclusive, upperInclusive);
    }


    public List<TstSharding> fetchRangeOfLanguageLive(StandardLanguage lowerInclusive, StandardLanguage upperInclusive) {
     ...
     */
    public List<TstSharding> fetchByLanguage(StandardLanguage... values) {
        return fetch(TstShardingTable.TstSharding.Language, values);
    }

    public List<TstSharding> fetchByLanguage(Collection<? extends StandardLanguage> values) {
        return fetch(TstShardingTable.TstSharding.Language, values);
    }


    public List<TstSharding> fetchByLanguageLive(StandardLanguage... values) {
        return fetchLive(TstShardingTable.TstSharding.Language, values);
    }

    public List<TstSharding> fetchByLanguageLive(Collection<? extends StandardLanguage> values) {
        return fetchLive(TstShardingTable.TstSharding.Language, values);
    }
}
