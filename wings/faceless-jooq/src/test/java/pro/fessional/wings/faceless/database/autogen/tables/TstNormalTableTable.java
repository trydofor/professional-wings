...
import pro.fessional.wings.faceless.database.autogen.tables.records.TstNormalTableRecord;
...
public class TstNormalTableTable extends TableImpl<TstNormalTableRecord> implements WingsJournalTable<TstNormalTableTable>, LightIdAware {
     ...
     */
    public final TableField<TstNormalTableRecord, StandardLanguage> ValueLang = createField(DSL.name("value_lang"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.inline("1020111", SQLDataType.INTEGER)), this, "", new JooqConsEnumConverter(pro.fessional.wings.faceless.enums.autogen.StandardLanguage.class));
     ...
     */
    public <U> SelectField<U> mapping(Function13<? super Long, ? super LocalDateTime, ? super LocalDateTime, ? super LocalDateTime, ? super Long, ? super String, ? super BigDecimal, ? super Boolean, ? super Integer, ? super Long, ? super LocalDate, ? super LocalTime, ? super StandardLanguage, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function13<? super Long, ? super LocalDateTime, ? super LocalDateTime, ? super LocalDateTime, ? super Long, ? super String, ? super BigDecimal, ? super Boolean, ? super Integer, ? super Long, ? super LocalDate, ? super LocalTime, ? super StandardLanguage, ? extends U> from) {
