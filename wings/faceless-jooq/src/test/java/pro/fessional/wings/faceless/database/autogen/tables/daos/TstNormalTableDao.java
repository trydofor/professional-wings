...
public class TstNormalTableDao extends WingsJooqDaoJournalImpl<TstNormalTableTable, TstNormalTableRecord, TstNormalTable, Long> {
     ...
     * upperInclusive</code>
     */
    public List<TstNormalTable> fetchRangeOfValueLang(StandardLanguage lowerInclusive, StandardLanguage upperInclusive) {
        return fetchRange(TstNormalTableTable.TstNormalTable.ValueLang, lowerInclusive, upperInclusive);
    }


    public List<TstNormalTable> fetchRangeOfValueLangLive(StandardLanguage lowerInclusive, StandardLanguage upperInclusive) {
     ...
     */
    public List<TstNormalTable> fetchByValueLang(StandardLanguage... values) {
        return fetch(TstNormalTableTable.TstNormalTable.ValueLang, values);
    }

    public List<TstNormalTable> fetchByValueLang(Collection<? extends StandardLanguage> values) {
        return fetch(TstNormalTableTable.TstNormalTable.ValueLang, values);
    }


    public List<TstNormalTable> fetchByValueLangLive(StandardLanguage... values) {
        return fetchLive(TstNormalTableTable.TstNormalTable.ValueLang, values);
    }

    public List<TstNormalTable> fetchByValueLangLive(Collection<? extends StandardLanguage> values) {
        return fetchLive(TstNormalTableTable.TstNormalTable.ValueLang, values);
    }
}
