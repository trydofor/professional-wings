...
CREATE TABLE `sys_schema_journal` (
    ...
    `log_insert` DATETIME(3)  NOT NULL DEFAULT '1000-01-01' COMMENT 'applied datetime of insert',
    `log_update` DATETIME(3)  NOT NULL DEFAULT '1000-01-01' COMMENT 'applied datetime of update',
    `log_delete` DATETIME(3)  NOT NULL DEFAULT '1000-01-01' COMMENT 'applied datetime of delete',
