...
public class TestEnabledCatConfiguration {

    private static final Log log = LogFactory.getLog(TestEnabledCatConfiguration.class);
    ...
    public TestEnabledCatConfiguration() {
        log.info(">>> init " + this);
