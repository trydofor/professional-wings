...
public class WingsEnabledDogConfiguration {

    private static final Log log = LogFactory.getLog(WingsEnabledDogConfiguration.class);
    ...
    public WingsEnabledDogConfiguration() {
        log.info(">>> init " + this);
