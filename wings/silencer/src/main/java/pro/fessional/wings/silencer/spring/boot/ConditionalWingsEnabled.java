...
public @interface ConditionalWingsEnabled {
    ...
    /**
     * absolute-key, without prefix, priority lower than qualified-key
     */
    String abs() default "";

    /**
     * relative-key, with prefix, priority lower than absolute-key
     *
     * @see WingsEnabledContext#PrefixEnabled
     */
    String key() default "";
