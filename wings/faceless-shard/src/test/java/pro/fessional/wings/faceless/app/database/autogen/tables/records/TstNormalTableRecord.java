...
public class TstNormalTableRecord extends UpdatableRecordImpl<TstNormalTableRecord> implements Record13<Long, LocalDateTime, LocalDateTime, LocalDateTime, Long, String, BigDecimal, Boolean, Integer, Long, LocalDate, LocalTime, Integer>, ITstNormalTable {
     ...
     */
    @Override
    public void setValueLang(Integer value) {
        set(12, value);
    }
    ...
    @Override
    public Row13<Long, LocalDateTime, LocalDateTime, LocalDateTime, Long, String, BigDecimal, Boolean, Integer, Long, LocalDate, LocalTime, Integer> valuesRow() {
    ...
    @Override
    public TstNormalTableRecord value13(Integer value) {
        setValueLang(value);
        return this;
    }

    @Override
    public TstNormalTableRecord values(Long value1, LocalDateTime value2, LocalDateTime value3, LocalDateTime value4, Long value5, String value6, BigDecimal value7, Boolean value8, Integer value9, Long value10, LocalDate value11, LocalTime value12, Integer value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TstNormalTableRecord(Long id, LocalDateTime createDt, LocalDateTime modifyDt, LocalDateTime deleteDt, Long commitId, String valueVarchar, BigDecimal valueDecimal, Boolean valueBoolean, Integer valueInt, Long valueLong, LocalDate valueDate, LocalTime valueTime, Integer valueLang) {
        super(TstNormalTableTable.TstNormalTable);
