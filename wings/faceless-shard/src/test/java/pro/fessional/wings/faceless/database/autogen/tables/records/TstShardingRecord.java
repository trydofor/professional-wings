...
public class TstShardingRecord extends UpdatableRecordImpl<TstShardingRecord> implements Record8<Long, LocalDateTime, LocalDateTime, LocalDateTime, Long, String, String, Integer>, ITstSharding {
    ...
    @Override
    public TstShardingRecord value8(Integer value) {
        setLanguage(value);
        return this;
    }

    @Override
    public TstShardingRecord values(Long value1, LocalDateTime value2, LocalDateTime value3, LocalDateTime value4, Long value5, String value6, String value7, Integer value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TstShardingRecord(Long id, LocalDateTime createDt, LocalDateTime modifyDt, LocalDateTime deleteDt, Long commitId, String loginInfo, String otherInfo, Integer language) {
        super(TstShardingTable.TstSharding);
