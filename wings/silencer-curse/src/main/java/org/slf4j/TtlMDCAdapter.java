 ...
 *
 * @author Ceki Gülcü, Michael Franz
 * @author trydofor
...
public class TtlMDCAdapter implements MDCAdapter {
    ...
    // BGN: trydofor
    public static final TtlMDCAdapter INSTANCE = new TtlMDCAdapter();

    public static void initMdc() {
        MDC.mdcAdapter = INSTANCE;
    }

    final ThreadLocal<Map<String, String>> readWriteThreadLocalMap = new TransmittableThreadLocal<Map<String, String>>();
    final ThreadLocal<Map<String, String>> readOnlyThreadLocalMap = new TransmittableThreadLocal<Map<String, String>>();
