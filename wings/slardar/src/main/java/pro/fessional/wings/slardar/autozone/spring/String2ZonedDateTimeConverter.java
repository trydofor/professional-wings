...
public class String2ZonedDateTimeConverter extends DateTimeFormatSupport implements AutoZoneAware {
    ...
    public Object convert(Object source, @NotNull TypeDescriptor sourceType, @NotNull TypeDescriptor targetType) {
        ...
        if (tma != null) {
            ...
            return autoZonedRequest(tma, anno == null ? autoZone : anno.value());
        }
